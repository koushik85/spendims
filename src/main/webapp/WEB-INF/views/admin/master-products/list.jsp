    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header flex">
                <div>
                    <h2><span class="page-title-main">Master Products</span></h2>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <c:if test="${empty masterProducts}">
                            <tr><td colspan="6" style="text-align:center;padding:40px;color:var(--color-text-muted);">No master products yet.</td></tr>
                        </c:if>
                    </tbody>
                </table>
            </div>
