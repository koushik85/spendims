		...
		<div class="row g-0">
			...
			<div class="main-content">
				...
				<div class="page-header flex">
					<div>
						<h2>
							<span class="page-title-main">Enterprises</span>
						</h2>
						<div class="page-subtitle">Approve or reject business
							account registrations.</div>
					</div>
				</div>
						...
						<tbody>
							<c:forEach var="e" items="${enterprises}">
								<tr>
									...
									<td><c:if test="${e.approvalStatus == 'PENDING'}">
											<div class="flex-gap-6">
												<form method="post"
													action="${pageContext.request.contextPath}/admin/enterprises/${e.enterpriseId}/approve">
													<button class="btn-action btn-adjust-plus">Approve</button>
												</form>
												<form method="post"
													action="${pageContext.request.contextPath}/admin/enterprises/${e.enterpriseId}/reject">
