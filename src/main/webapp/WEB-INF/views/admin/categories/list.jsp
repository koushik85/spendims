    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header flex">
                ...
                <a href="/spendilizer/admin/categories/new" class="btn-primary-custom">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex-gap-6">
                                        <a href="/spendilizer/admin/categories/edit/${cat.id}" class="btn-action btn-edit">Edit</a>
                                        <form method="post" action="/spendilizer/admin/categories/delete/${cat.id}"
