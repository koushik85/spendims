...
<header class="ims-topbar">
	...
	<c:if test="${not empty user}">
		<div class="topbar-user-chip">
			<c:choose>
				...
				<c:when
					test="${user.accountType == 'ENTERPRISE_OWNER' or user.accountType == 'ENTERPRISE_MEMBER'}">
					...
					<div class="tuc-text">
						...
						<div class="tuc-secondary">${user.firstName}
							${user.lastName}
	...
	<c:if
		test="${not empty user && (user.accountType == 'ENTERPRISE_OWNER' || user.accountType == 'ENTERPRISE_MEMBER')}">
