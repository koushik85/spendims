...
<body>
	...
	<div class="left-panel">
		...
		<div class="brand-tagline">A complete automation suite for
			smarter inventory management.</div>
	...
	<div class="right-panel">
		<div class="login-box">
			...
			<c:choose>
				<c:when test="${param.error == 'pending'}">
					<div class="flash-error"
						style="background: #fef9c3; border-color: #fde047; color: #854d0e;">
						<svg width="16" height="16" fill="none" viewBox="0 0 24 24"
							stroke="currentColor" stroke-width="2" style="flex-shrink: 0;">
						...
						Your business account is pending approval. You'll be notified once
						a Super Admin reviews it.
					</div>
				</c:when>
				<c:when test="${param.error == 'rejected'}">
					<div class="flash-error">
						...
						Your business account registration was rejected. Please contact
						support.
					</div>
				</c:when>
			...
			<form action="${pageContext.request.contextPath}/perform-login"
				...
				<div class="form-group">
					...
					<div class="input-wrap">
						...
						<button type="button" class="toggle-pw"
							...
							<svg id="eyeIcon" width="16" height="16" fill="none"
								viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round"
				...
				<div class="extras-row">
					<label class="remember-label"> <input type="checkbox"
						id="rememberMe" name="remember-me"> Remember me
					</label>
				</div>
			...
			<div
				style="text-align: center; margin-top: 18px; font-size: 0.82rem; color: #64748b;">
				Don't have an account? <a
					href="${pageContext.request.contextPath}/signup"
					style="color: #0f766e; text-decoration: none; font-weight: 600;">Sign
					up</a>
			</div>
