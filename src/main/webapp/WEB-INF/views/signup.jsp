...
<body>
	...
	<div class="left-panel">
		...
		<div class="brand-tagline">Personal finance tools and inventory
			management — in one place.</div>
	...
	<div class="right-panel">
		<div class="login-box">
			...
			<div class="type-selector">
				<div
					class="type-card ${empty activeTab || activeTab == 'INDIVIDUAL' ? 'active' : ''}"
			...
			<div id="type-hint"
				style="font-size: 0.76rem; color: var(--color-text-muted); margin: -18px 0 20px; line-height: 1.5;">
				<span id="hint-individual">Track shared expenses, manage
					subscriptions, and stay on top of personal finances.</span> <span
					id="hint-enterprise" style="display: none;">Full inventory
					system — products, stock, orders, invoices — plus personal finance
					tools.</span>
			</div>

			<div id="enterprise-approval-note"
				style="display: none; font-size: 0.76rem; background: #fef9c3; border: 1px solid #fde047; color: #854d0e; border-radius: 8px; padding: 10px 14px; margin-bottom: 18px; line-height: 1.5;">
				Business accounts require Super Admin approval before you can sign
				in. You will receive access once your account is reviewed.</div>
			...
			<form action="${pageContext.request.contextPath}/signup"
				...
				<div class="form-group" id="field-company"
					...
					<div class="input-wrap">
						<svg class="input-icon" width="15" height="15" fill="none"
				...
				<div class="form-group">
					...
					<div class="input-wrap">
						...
						<button type="button" class="toggle-pw"
							onclick="togglePw('password','eyeIcon1')" title="Show / hide">
				...
				<div class="form-group">
					...
					<div class="input-wrap">
						...
						<button type="button" class="toggle-pw"
							onclick="togglePw('confirmPassword','eyeIcon2')"
							title="Show / hide">
				...
				<%-- PAN Number --%>
				<div class="form-group">
					<label for="pan">PAN Number <span
						style="font-size: 0.75rem; color: var(--color-text-muted); font-weight: 400;">(optional)</span></label>
					<div class="input-wrap">
						<svg class="input-icon" width="15" height="15" fill="none"
							viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round"
						...
						<input type="text" id="pan" name="pan"
							...
							style="text-transform: uppercase;" oninput="validatePan(this)">
					</div>
					<div id="panError"
						style="display: none; color: #dc2626; font-size: 0.76rem; margin-top: 4px;">
						Invalid PAN. Format: 5 letters · 4 digits · 1 letter (e.g.
						ABCDE1234F)</div>
				</div>
			...
			<div class="login-footer">© 2025 Spendilizer · Inventory
