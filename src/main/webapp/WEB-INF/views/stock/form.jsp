        ...
        <div class="main-content">
            ...
            <div class="page-header">
                <h2>
                    ...
                    ${empty stock.id ? 'Add Stock Entry' : 'Edit Stock Entry'}
                </h2>
                <div class="page-subtitle">
                    ${empty stock.id ? 'Link a product to its inventory quantity and threshold.' : 'Update quantity, threshold, or status for this stock entry.'}
                </div>
            </div>
            ...
            <c:if test="${not empty stock.id}">
                <div class="edit-mode-banner">
                    ...
                    Editing stock for: <strong>${stock.product.name}</strong> &nbsp;·&nbsp; Stock ID: ${stock.id}
                </div>
            </c:if>
                    ...
                    <form action="/spendilizer/stock/${empty stock.id ? 'new' : 'edit/'.concat(stock.id)}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="productId" name="product.id" required
                                        ${not empty stock.id ? 'disabled' : ''}>
                                    <option value="" disabled ${empty stock.product ? 'selected' : ''}>
                                        — Select a product —
                                    </option>
                            ...
                            <c:if test="${not empty stock.id}">
                                ...
                                <div class="field-hint">Product cannot be changed after creation.</div>
                            </c:if>
                        </div>
                        ...
                        <div class="form-row-2">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                <label for="minThreshold">
                                    Min Threshold <span class="required">*</span>
                                </label>
                                <input type="number"
                                       id="minThreshold"
                                       name="minThreshold"
                                       ...
                                       min="0"
                                       required>
                                <div class="field-hint">Alert when quantity reaches this level.</div>
                            </div>
                        </div>

                        <div class="threshold-hint" id="lowStockWarning" style="display:none; margin-top: 16px;">
