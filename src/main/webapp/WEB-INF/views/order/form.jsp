        ...
        <div class="main-content">
            ...
            <div class="page-header with-icon">
                ...
                <div class="page-subtitle">
                    ${empty order.id ? 'Select customer, add items.' : 'Update the draft order.'}
                </div>
            </div>
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="orderDate" name="orderDate"
                                       value="${not empty order.orderDate ? order.orderDate : ''}" required>
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label for="expectedDeliveryDate">Expected Delivery <span class="optional">optional</span></label>
                        ...
                        <div class="form-row">
                            <div class="form-group" style="grid-column: 1 / -1;">
                                ...
                                <input type="text" id="notes" name="notes" value="${order.notes}" placeholder="Internal notes…">
                            </div>
                        </div>
