    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <a href="/spendilizer/order/new" class="btn-primary-custom">
                    ...
                    <tbody>
                        <c:forEach var="o" items="${orders}" varStatus="loop">
                            <tr>
                                ...
                                <td class="fw-500">
                                    <a href="/spendilizer/order/${o.id}" style="color:var(--color-primary);text-decoration:none;">
                                        ${o.orderNumber}
                                    </a>
                                </td>
                                ...
                                <td>
                                    <div class="flex-gap-6">
                                        <a href="/spendilizer/order/${o.id}" class="btn-action btn-edit">View</a>
                                        <c:if test="${o.status == 'DRAFT'}">
                                            <a href="/spendilizer/order/edit/${o.id}" class="btn-action btn-edit">Edit</a>
                                        </c:if>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p>No orders yet. <a href="/spendilizer/order/new" style="color:var(--color-primary);">Create one now.</a></p>
                                    </div>
                                </td>
                            </tr>
                        </c:if>
