    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <a href="/spendilizer/stock-movement/new" class="btn-primary-custom">
            ...
            <%-- Filter bar --%>
            <form action="/spendilizer/stock-movement" method="get">
                <div class="filter-bar">
                    ...
                    <c:if test="${not empty filterProductId or not empty filterType}">
                        <a href="/spendilizer/stock-movement" class="btn-filter">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex; gap:6px; align-items:center;">
                                        <a href="/spendilizer/stock-movement/edit/${m.id}" class="btn-action btn-edit">
                                            <svg width="12" height="12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2">
                                        ...
                                        <form action="/spendilizer/stock-movement/delete/${m.id}" method="post" style="margin:0;"
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        ...
                                        <p>No movements found. <a href="/spendilizer/stock-movement/new" style="color:var(--color-primary);">Record one now.</a></p>
                                    </div>
                                </td>
                            </tr>
                        </c:if>
