            ...
            <div class="page-header flex">
                <div>
                    <h2>
                        ...
                        <span class="page-title-main">My Finance</span>
                    </h2>
                    <div class="page-subtitle">Your splits and subscriptions at a glance</div>
                </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-6 col-md-3">
                    <div class="stat-card card-amber">
                        ...
                        <div class="stat-value" style="font-size:1.05rem;">&#8377;<fmt:formatNumber value="${monthlyCost}" pattern="#,##0.00"/></div>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <table class="activity-table">
                                    <thead><tr><th>Group</th><th>Date</th><th>Status</th></tr></thead>
                                    <tbody>
                                        <c:forEach var="g" items="${recentGroups}">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${g.status == 'ACTIVE'}"><span class="badge-pill badge-in">ACTIVE</span></c:when>
                                                        <c:otherwise><span class="badge-pill badge-out">CLOSED</span></c:otherwise>
                                                    </c:choose>
                                                </td>
                                            </tr>
                                        </c:forEach>
                ...
                <div class="col-12 col-lg-6">
                    <div class="activity-card">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <table class="activity-table">
                                    <thead><tr><th>Subscription</th><th>Amount</th><th>Due</th></tr></thead>
                                    <tbody>
                                        <c:forEach var="s" items="${upcomingRenewals}">
                                            <tr>
                                                <td style="font-weight:500;"><c:out value="${s.name}"/></td>
                                                <td>&#8377;<fmt:formatNumber value="${s.amount}" pattern="#,##0.00"/></td>
