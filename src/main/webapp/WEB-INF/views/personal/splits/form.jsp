			...
			<div class="main-content">
				...
				<div class="breadcrumb-bar">
					<a href="${pageContext.request.contextPath}/personal/splits">Split
						Groups</a> <span class="sep">›</span> <span class="current">New
						Group</span>
				</div>

				<div class="page-header">
					<h2>Create Split Group</h2>
					<div class="page-subtitle">Set up a group to track and split
						shared expenses</div>
				</div>

				<form
					action="${pageContext.request.contextPath}/personal/splits/new"
					method="post">
						...
						<div class="form-card-header">
							<div
								...
								<button type="button" class="btn-cancel"
									...
									style="padding: 5px 14px; font-size: 0.78rem;">+ Add
									Member</button>
							</div>
						</div>
						<div class="form-card-body">

							<div class="field-hint" style="margin-bottom: 14px;">You
								are automatically added as the first member. Add others by name
								— if they have a Spendilizer account, enter their registered
								email to link them.</div>

							<div class="members-col-labels">
								<span>Name <span style="color: var(--color-danger)">*</span></span>
								<span>Email (optional)</span> <span style="width: 32px;"></span>
							</div>
							...
							<div id="membersList">
								<div class="member-row">
									<input type="text" name="memberName" class="form-group"
										...
										placeholder="email@example.com"> <span class="spacer"></span>
								</div>
								<div class="member-row">
									...
									<button type="button" class="btn-remove-member"
										onclick="this.closest('.member-row').remove()" title="Remove">
                            ...
                            <path stroke-linecap="round"
								...
								<a href="${pageContext.request.contextPath}/personal/splits"
