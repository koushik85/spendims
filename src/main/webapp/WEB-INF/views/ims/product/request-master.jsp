    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                <div>
                    <h2><span class="page-title-main">Request Product</span></h2>
                    <div class="page-subtitle">Submit a product for the global master catalog — a Super Admin will review it.</div>
                </div>
            </div>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/product/request-master">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="categoryName" name="categoryName" value="${request.categoryName}" required>
                            </div>
                            ...
                            <div class="form-group" style="position: relative;">
                                ...
                                <div class="field-hint">Search and select a valid HSN code.</div>
                            </div>

                            <div class="form-group span-2">
                                <label for="description">Description <span class="optional">optional</span></label>
                                <textarea id="description" name="description" rows="3" placeholder="Brief description of the requested product...">${request.description}</textarea>
                            </div>
                        </div>
