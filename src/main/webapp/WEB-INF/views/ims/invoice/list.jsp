		...
		<div class="row g-0">
			...
			<div class="main-content">
				...
				<div class="page-header">
					<div>
						<h2>Invoices</h2>
						<div class="page-subtitle">Manage customer invoices and
							payments</div>
					</div>
				...
				<div class="search-bar">
					...
					<input type="text" id="searchInput" placeholder="Search invoices…"
						onkeyup="filterTable('invoiceTable')">
				</div>
				...
				<div class="table-card">
						...
						<tbody>
							<c:forEach var="inv" items="${invoices}" varStatus="loop">
								<tr>
									...
									<td class="fw-500"><a
										href="${pageContext.request.contextPath}/invoice/${inv.id}"
										style="color: var(--color-primary); text-decoration: none;">
											${inv.invoiceNumber} </a></td>
									...
									<td>
										<div class="flex-gap-6">
											...
											<c:if test="${inv.status == 'DRAFT'}">
												<a
													href="${pageContext.request.contextPath}/invoice/edit/${inv.id}"
								...
								<tr>
									<td colspan="9">
										<div class="empty-state">
											...
											<p>
												No invoices yet. <a
													href="${pageContext.request.contextPath}/invoice/new"
													style="color: var(--color-primary);">Create one now.</a>
											</p>
										</div>
									</td>
								</tr>
					...
					<c:if test="${not empty invoices}">
						<div class="table-footer">
							Showing <span id="visibleCount">${invoices.size()}</span> of
