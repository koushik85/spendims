    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <a href="${pageContext.request.contextPath}/customer/new" class="btn-primary-custom">
            ...
            <div class="search-bar">
                ...
                <input type="text" id="searchInput" placeholder="Search customers…" onkeyup="filterTable('customerTable')">
            </div>
            ...
            <div class="table-card">
                    ...
                    <tbody>
                        <c:forEach var="c" items="${customers}" varStatus="loop">
                            <tr>
                                ...
                                <td class="fw-500">
                                    ${c.displayName}
                                    <c:if test="${not empty c.companyName}">
                                        <br><small class="text-muted">${c.firstName} ${c.lastName}</small>
                                    </c:if>
                                </td>
                                ...
                                <td>
                                    <div class="flex-gap-6">
                                        <a href="${pageContext.request.contextPath}/customer/edit/${c.id}" class="btn-action btn-edit">
                                        ...
                                        <form action="${pageContext.request.contextPath}/customer/delete/${c.id}" method="post" style="margin:0;"
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <p>No customers found. <a href="${pageContext.request.contextPath}/customer/new" style="color:var(--color-primary);">Add one now.</a></p>
                                    </div>
                                </td>
                            </tr>
                        </c:if>
                ...
                <c:if test="${not empty customers}">
                    <div class="table-footer">
                        Showing <span id="visibleCount">${customers.size()}</span> of ${customers.size()} customers
                    </div>
                </c:if>
            </div>
