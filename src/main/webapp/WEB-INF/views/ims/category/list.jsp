			...
			<div class="main-content">
				...
				<div class="search-bar">
					...
					<input type="text" id="searchInput"
						...
						onkeyup="filterTable('categoryTable')">
				</div>
				...
				<div class="table-card">
								...
								<tr>
									...
									<td style="color: var(--color-text-muted); max-width: 320px;">
										<c:choose>
											...
											<c:otherwise>
												<span style="font-style: italic; opacity: 0.5;">—</span>
											</c:otherwise>
										</c:choose>
									</td>
									<td>
										<div style="display: flex; gap: 6px; align-items: center;">
											<a
												href="${pageContext.request.contextPath}/category/edit/${cat.id}"
											...
											<form
												action="${pageContext.request.contextPath}/category/delete/${cat.id}"
					...
					<c:if test="${not empty categories}">
						<div class="table-footer">
							Showing <span id="visibleCount">${categories.size()}</span> of
