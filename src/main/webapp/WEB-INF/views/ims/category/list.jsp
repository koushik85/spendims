    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <a href="${pageContext.request.contextPath}/category/new" class="btn-primary-custom">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex; gap: 6px; align-items: center;">
                                        <a href="${pageContext.request.contextPath}/category/edit/${cat.id}" class="btn-action btn-edit">
                                        ...
                                        <form action="${pageContext.request.contextPath}/category/delete/${cat.id}" method="post" style="margin:0;"
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        <p>No categories found. <a href="${pageContext.request.contextPath}/category/new" style="color: var(--color-primary);">Add one now.</a></p>
                                    </div>
                                </td>
                            </tr>
                        </c:if>
