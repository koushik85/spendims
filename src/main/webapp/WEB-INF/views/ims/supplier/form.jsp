...
<html>
<head>
<title>${empty supplier.id ? 'Add Supplier' : 'Edit Supplier'}—
	IMS</title>
			...
			<div class="main-content">
				...
				<div class="breadcrumb-bar">
					...
					<span class="sep">›</span> <a
						href="${pageContext.request.contextPath}/supplier">Suppliers</a> <span
						class="sep">›</span> <span class="current">${empty supplier.id ? 'New Supplier' : 'Edit Supplier'}</span>
				</div>
				...
				<div class="page-header with-icon">
					<h2>
						...
						</span> ${empty supplier.id ? 'Add New Supplier' : 'Edit Supplier'}
					</h2>
					<div class="page-subtitle">${empty supplier.id ? 'Fill in the details to register a new supplier.' : 'Update the supplier details below.'}
					</div>
				</div>
				...
				<c:if test="${not empty supplier.id}">
					<div class="edit-mode-banner">
						...
						Editing: <strong>${supplier.name}</strong> &nbsp;·&nbsp; ID:
						${supplier.id}
					</div>
				</c:if>
				...
				<div class="form-card">
					...
					<div class="form-card-body">
						...
						<form
							action="${pageContext.request.contextPath}/supplier/${empty supplier.id ? 'new' : 'edit/'.concat(supplier.id)}"
							method="post">
							...
							<div class="form-row">
								<div class="form-group">
									<label for="name"> Supplier Name <span class="required">*</span>
										...
										value="${supplier.name}" placeholder="e.g. Acme Corp" required
										autofocus>
								</div>
								...
								<div class="form-group">
									<label for="email"> Email <span class="required">*</span>
										...
										required>
									<div class="field-hint">Must be unique across all
										suppliers.</div>
								</div>
							</div>
							...
							<div class="form-group">
								<label for="phone"> Phone <span class="optional">optional</span>
									...
									value="${supplier.phone}" placeholder="e.g. +91 98765 43210">
							</div>

							<%-- Address --%>
							<div class="form-group">
								<label for="address"> Address <span class="optional">optional</span>
								</label>
