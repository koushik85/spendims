    ...
    <div class="row g-0">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <a href="${pageContext.request.contextPath}/supplier/new" class="btn-primary-custom">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex-gap-6">
                                        <a href="${pageContext.request.contextPath}/supplier/edit/${sup.id}" class="btn-action btn-edit">
                                        ...
                                        <form action="${pageContext.request.contextPath}/supplier/delete/${sup.id}" method="post" style="margin:0;"
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <p>No suppliers found. <a href="${pageContext.request.contextPath}/supplier/new" style="color:var(--color-primary);">Add one now.</a></p>
                                    </div>
                                </td>
                            </tr>
                        </c:if>
