			...
			<div class="main-content">
				...
				<c:if test="${lowStockCount > 0}">
					<div class="alert-banner">
						...
						<span> <strong>${lowStockCount} product(s)</strong> are
							below minimum stock threshold.&nbsp; <a
							href="${pageContext.request.contextPath}/stock">View stock
								&rarr;</a>
						</span>
					</div>
				</c:if>
					...
					<div class="col-6 col-md-4 col-lg-3">
						<div class="stat-card card-green">
							...
							<div class="stat-value" style="font-size: 1.1rem;">
								&#8377;
								<fmt:formatNumber value="${paidRevenue}" pattern="#,##0" />
							</div>
				...
				<div class="row g-2">
					<div class="col-12 col-sm-6 col-lg-3">
						<a href="${pageContext.request.contextPath}/product/new"
							class="quick-action"> <span class="qa-icon"> <svg
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<a href="${pageContext.request.contextPath}/supplier/new"
							class="quick-action"> <span class="qa-icon"> <svg
									width="14" height="14" fill="none" viewBox="0 0 24 24"
									stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round"
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<a href="${pageContext.request.contextPath}/stock-movement"
							class="quick-action"> <span class="qa-icon"> <svg
									width="14" height="14" fill="none" viewBox="0 0 24 24"
									stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round"
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<a href="${pageContext.request.contextPath}/stock"
							class="quick-action"> <span class="qa-icon"> <svg
									...
									stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round"
										stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                            </svg>
						</span> Stock overview
						</a>
					</div>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<a href="${pageContext.request.contextPath}/product"
							class="quick-action"> <span class="qa-icon"> <svg
									...
									stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round"
										stroke-linejoin="round" d="M4 6h16M4 12h8m-8 6h16" />
                            </svg>
						</span> All products
						</a>
					</div>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<a href="${pageContext.request.contextPath}/invoice/new"
							class="quick-action"> <span class="qa-icon"> <svg
									width="14" height="14" fill="none" viewBox="0 0 24 24"
									stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round"
				...
				<div class="activity-card">
					<div class="activity-header">
						<span>Latest movements</span> <a
							href="${pageContext.request.contextPath}/stock-movement">View
							all &rarr;</a>
					</div>
								...
								<tr>
									...
									<td><c:choose>
											<c:when test="${m.type == 'IN'}">
												<span class="badge-pill badge-in"> <svg width="8"
														height="8" viewBox="0 0 8 8" fill="currentColor">
														<circle cx="4" cy="4" r="4" /></svg> IN
												</span>
											</c:when>
											<c:when test="${m.type == 'OUT'}">
												<span class="badge-pill badge-out"> <svg width="8"
														height="8" viewBox="0 0 8 8" fill="currentColor">
														<circle cx="4" cy="4" r="4" /></svg> OUT
												</span>
											</c:when>
											<c:otherwise>
												<span class="badge-pill badge-adj"> <svg width="8"
														height="8" viewBox="0 0 8 8" fill="currentColor">
														<circle cx="4" cy="4" r="4" /></svg> ADJ
												</span>
											</c:otherwise>
										</c:choose></td>
									<td class="qty-cell"><c:choose>
											<c:when test="${m.type == 'IN'}">+${m.quantity}</c:when>
											<c:when test="${m.type == 'OUT'}">-${m.quantity}</c:when>
											<c:otherwise>${m.quantity}</c:otherwise>
										</c:choose></td>
									<td class="note-cell"><c:choose>
									...
									<td class="date-cell"><c:out value="${m.movedAt}"
											default="—" /></td>
								</tr>
							</c:forEach>
